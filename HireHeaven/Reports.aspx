...
<head runat="server">
    ...
    <title>Admin Reports - HireHeaven</title>
    ...
    <form id="form1" runat="server">
        ...
        <main class="container mx-auto p-6">
            <div class="text-center my-12">
                <h1 class="text-4xl md:text-5xl font-extrabold mb-2 text-accent">Portal Reports</h1>
                <p class="text-lg text-secondary">Analyze trends and monitor activity across the platform.</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="space-y-8">
                    <div class="card-bg p-6 rounded-lg shadow-md border border-themed">
                        <h3 class="text-2xl font-bold text-primary mb-4">Job Distribution by Category</h3>
                        <asp:Repeater ID="rptJobDistribution" runat="server">
                            <HeaderTemplate><table class="w-full text-sm text-left"><thead class="text-xs text-secondary uppercase card-secondary-bg"><tr><th class="px-6 py-3">Category</th><th class="px-6 py-3 text-right">Jobs Posted</th></tr></thead><tbody></HeaderTemplate>
                            <ItemTemplate><tr class="border-b border-themed"><td class="px-6 py-4 font-medium text-primary"><%# Eval("Category") %></td><td class="px-6 py-4 text-right text-secondary"><%# Eval("JobsPosted") %></td></tr></ItemTemplate>
                            <FooterTemplate></tbody></table></FooterTemplate>
                        </asp:Repeater>
                    </div>

                    <div class="card-bg p-6 rounded-lg shadow-md border border-themed">
                        <h3 class="text-2xl font-bold text-primary mb-4">Top Employer Activity</h3>
                         <asp:Repeater ID="rptEmployerActivity" runat="server">
                            <HeaderTemplate><table class="w-full text-sm text-left"><thead class="text-xs text-secondary uppercase card-secondary-bg"><tr><th class="px-6 py-3">Employer Name</th><th class="px-6 py-3 text-right">Jobs Posted</th></tr></thead><tbody></HeaderTemplate>
                            <ItemTemplate><tr class="border-b border-themed"><td class="px-6 py-4 font-medium text-primary"><%# Eval("EmployerName") %></td><td class="px-6 py-4 text-right text-secondary"><%# Eval("JobsPosted") %></td></tr></ItemTemplate>
                            <FooterTemplate></tbody></table></FooterTemplate>
                        </asp:Repeater>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    <div class="card-bg p-6 rounded-lg shadow-md border border-themed">
                        <h3 class="text-2xl font-bold text-primary mb-4">Applications by Job Title</h3>
                        <asp:Repeater ID="rptApplicationReport" runat="server">
                            <HeaderTemplate><table class="w-full text-sm text-left"><thead class="text-xs text-secondary uppercase card-secondary-bg"><tr><th class="px-6 py-3">Job Title</th><th class="px-6 py-3">Employer</th><th class="px-6 py-3 text-right">Applications</th></tr></thead><tbody></HeaderTemplate>
                            <ItemTemplate><tr class="border-b border-themed"><td class="px-6 py-4 font-medium text-primary"><%# Eval("JobTitle") %></td><td class="px-6 py-4 text-secondary"><%# Eval("Employer") %></td><td class="px-6 py-4 text-right text-secondary"><%# Eval("ApplicationCount") %></td></tr></ItemTemplate>
                            <FooterTemplate></tbody></table></FooterTemplate>
                        </asp:Repeater>
                    </div>
